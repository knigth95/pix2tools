...
class FormulaRecognizerApp:
    def __init__(self, master):
        ...
        # 截图按钮
        self.screenshot_btn = Button(master, text="火山截图", command=self.capture_screenshot, font=btn_font, height=3, width=20)
        self.screenshot_btn.pack(pady=10)
        
        # 识别按钮
        self.recognize_btn = Button(master, text="latex识别", command=self.recognize_formula, font=btn_font, height=2, width=20)
